...
struct MBMessage 
{
    ...
    MBMessage(void):callbackFunc(NULL),callbackArg(NULL),reSend(0){}
...
private:
    ...
    void fmtChk_10(std::vector<mbu8> &recData);            //检查回复的数据报文格式是否正确
...
public:
    ...
    void masterFun10(mbu8 devId, mbu16 mbAddr, const std::vector<mbu16> regValue, 
